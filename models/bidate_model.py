...
class BiDateLULCNet(nn.Module):
    def __init__(self, n_channels, n_classes, n_classes_lulc):
        super(BiDateLULCNet, self).__init__()
        self.inc = inconv(n_channels, 64)
        self.down1 = down(64, 128)
        self.down2 = down(128, 256)
        self.down3 = down(256, 512)
        ...
        self.up4 = up(128, 64)
        self.outc = outconv(64, n_classes)
        self.outc_lulc = outconv(64, n_classes_lulc)
