...
class BiDateNet(nn.Module):
    def __init__(self, n_channels, n_classes):
        ...
        self.inc_d1 = inconv(n_channels, 64)
        self.down1_d1 = down(64, 128)
        self.down2_d1 = down(128, 256)
        self.down3_d1 = down(256, 512)
        self.down4_d1 = down(512, 512)
        
        self.inc_d2 = inconv(n_channels, 64)
        self.down1_d2 = down(64, 128)
        self.down2_d2 = down(128, 256)
        self.down3_d2 = down(256, 512)
        self.down4_d2 = down(512, 512)
