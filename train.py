...
torch.save(model, os.path.join(experiment.get_artifacts_path(), 'checkpoint_epoch_artifacts_path.pt'))
torch.save(model, os.path.join('/artifacts/', 'checkpoint_epoch_manual_save.pt'))
