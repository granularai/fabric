...
from utils.dataloaders import OneraPreloader, onera_siamese_loader, full_onera_loader_with_pc_priors
...
class UNet(nn.Module):
    def __init__(self, layers, init_filters):
        ...
        self.data_norm = nn.BatchNorm2d(19)
        self.init_layer = nn.Conv2d(19, init_filters, (7, 7), padding=3)
        self.activation = nn.ReLU()
...
# weights = torch.load('../weights/onera/unet_siamese_prod_relu_inp32_13band_6pcpriors_2dates_focal_hm_cnc_all_14_cities.pt', map_location=lambda storage, loc: storage.cuda(DEVICE))
# net.load_state_dict(weights)

criterion = get_loss(loss_func)
optimizer = optim.Adam(net.parameters(), lr=lr)

full_load = full_onera_loader_with_pc_priors(data_dir, bands)
...
#         best_net_dict = copy.deepcopy(net.state_dict())
        ...
        torch.save(net.state_dict(), '../weights/onera/unet_siamese_prod_relu_inp32_13band_6pcpriors_2dates_' + loss_func + '_hm_cnc_all_14_cities.pt')
